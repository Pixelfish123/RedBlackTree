 ...
 * user), and then 2) capturing the output printed to System.out and System.err
 * in String form so that it can be compared to the expect output.
 * 
 * @author dahl
 * @date 2021.10
 */
public class TextUITester {
	...
	/**
	 * This main method demonstrates the use of a TextUITester object to check the
	 * behavior of the following run method.
	 * 
	 ...
	 * welcome message, 2) reads a String, a double, and a character from System.in,
	 * and then 3) prints out the string followed by a number that is one greater
	 * than that double, if the character that it read in was a (lower case) 'q'.
	 */
	 ...
	 * also un-redirect standard io, so that the console can be used as normal
	 * again.
	 * 
